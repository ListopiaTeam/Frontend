...
const Register = () => {
  ...
  return (
    <div className='mt-32 flex justify-center'>
        <form onSubmit={handleRegistration} className='max-w-lg m-auto gap-5 flex flex-col mx-5'>
        ...
        <label
            ...
            <span
                className="absolute start-3 top-3 -translate-y-1/2 text-xs transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-3 peer-focus:text-xs text-slate-600 select-none"
            >
                Username
            </span>
            </label>
